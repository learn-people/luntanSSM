 ...
 * */
 $("#comment_add").click(function(){
   ...
   $("#commentAddModal").dialog("open");
 });
 
//添加模态框 点击保存按钮的事件
 $("#comment_add_save_btn").click(function(){
	 //查看是否添加了图片
	 if ($("#add_imgName").val()) {
 ...
 function add_saveData(){		
	 var content = $("#commentContent_add_input").val();
	 
	 if(content == null || content == ""){
		 alert("请输入内容");
	 }else{
	   $.ajax({
		 url:"/luntanSSM/comment/insert.do",
		 type:"POST",
